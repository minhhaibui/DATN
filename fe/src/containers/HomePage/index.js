      ...
      <Row className="container">
        ...
        <Col span={24} className="adv box-sha-home bor-rad-8 m-b-32">
          <a href="https://www.apple.com/watch/" target="blank">
            <img
              ...
              src="https://res.cloudinary.com/t-engine/image/upload/v1657045783/1_iorzsj_zbex2x.webp"
            />
          </a>
        </Col>
        ...
        <Col span={24} className="adv box-sha-home bor-rad-8 m-b-32">
          <a href="https://www.panasonic.com/vn/" target="blank">
            <img
              className="adv-img w-100 bor-rad-8"
              src="https://res.cloudinary.com/t-engine/image/upload/v1657045810/2_wapowv_godllt.webp"
            />
          </a>
        </Col>
